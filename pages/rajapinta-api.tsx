            ...
            <main className="container">
                <div className="breakRows">
                    ...
                    <ul className="api-list">
                        <li>
                            <p>Kaikki liputuspäivät: <ApiLink href="/api/liputuspaivat">/api/liputuspaivat</ApiLink></p>
                        </li>
                        <li>
                            <p>Kuluvan viikon liputuspäivät: <ApiLink href="/api/liputuspaivat/thisWeek">/api/liputuspaivat/thisWeek</ApiLink></p>
                        </li>
                        <li>
                            <p>Kuluvan kuun liputuspäivät: <ApiLink href="/api/liputuspaivat/thisMonth">/api/liputuspaivat/thisMonth</ApiLink></p>
                        </li>
                        <li>
                            <p>Kuluvan päivän liputuspäivät: <ApiLink href="/api/liputuspaivat/today">/api/liputuspaivat/today</ApiLink></p>
                        </li>
                    </ul>
